...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/schemathesis-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/schemathesis-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add schemathesis
# for installing globally
pixi global install schemathesis
```
...
It is possible to list all of the versions of `schemathesis` available on your platform:
...
```
pixi search schemathesis --channel conda-forge
```
